...
textures = [('chess',1),('picnic',2), ('noise',3),('wood',4),('lines',5),('marble',8),('cloud',7),('smooth',8)]
...
def drawAllStyles():
    styles = ["noise","smooth","cloud","marble","wood", "chess"]
    for style in styles:
